...
export default function UserProfile({ user }) {
  ...
  return (
    <div
      className="bg-white w-[370px] h-[310px] mx-3 absolute top-25 right-0 z-30 px-3 py-3
     rounded md:w-[350px] md:h-[320px] md:right-8 md:mx-0 md:top-20"
    >
      <div
        className="text-white w-[330px] h-[125px] bg-white rounded shadow-[2px_2px_2px_2px]
